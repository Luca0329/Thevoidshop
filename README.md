...
```
ritual-protection    → Ritual use: protection
limited-edition     → Limited edition flag
rarity-legendary    → Rarity level: legendary
energy-lunar        → Energy alignment: lunar
```
...
*Built with 🌙 mystical energy by [Your Name]*
